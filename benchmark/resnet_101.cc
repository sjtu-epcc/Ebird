/*
 * Created Date: Wednesday, June 26th 2019, 4:04:51 pm
 * Author: Raphael-Hao
 * -----
 * Last Modified: Monday, March 16th 2020, 2:40:41 pm
...
int main(int argc, char *argv[]) {
  ...
  BaseLayer<float> *input_1 = resnet_101(1, 1);
  BaseLayer<float> *input_2 = resnet_101(2, 2);
  BaseLayer<float> *input_4 = resnet_101(3, 4);
  BaseLayer<float> *input_8 = resnet_101(4, 8);
  BaseLayer<float> *input_16 = resnet_101(5, 16);
  BaseLayer<float> *input_16_1 = resnet_101(6, 16);
  // BaseLayer<float> *input_32 = resnet_101(6, 32);

  size_t input_size = RESNET_101_C * RESNET_101_H * RESNET_101_W;
