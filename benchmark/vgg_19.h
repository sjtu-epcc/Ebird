/*
 * Created Date: Wednesday, June 26th 2019, 2:21:44 pm
 * Author: Raphael-Hao
 * -----
...
BaseLayer<float> *vgg_19(int stream_id, size_t batch_size) {
  ...
  BaseLayer<float> *input = (BaseLayer<float> *)new DataLayer<float>(
      compute_stream, DATA_INFER, batch_size, VGG_19_C, VGG_19_H, VGG_19_W);
  ...
  BaseLayer<float> *act3_3 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
  BaseLayer<float> *conv3_4 = (BaseLayer<float> *)new ConvolutionLayer<float>(
      compute_stream, 256, 3, 1, 1, 1, new XavierInitializer<float>(), true);
  BaseLayer<float> *act3_4 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
  ...
  BaseLayer<float> *act4_3 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
  BaseLayer<float> *conv4_4 = (BaseLayer<float> *)new ConvolutionLayer<float>(
      compute_stream, 512, 3, 1, 1, 1, new XavierInitializer<float>(), true);
  BaseLayer<float> *act4_4 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
  ...
  BaseLayer<float> *act5_3 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
  BaseLayer<float> *conv5_4 = (BaseLayer<float> *)new ConvolutionLayer<float>(
      compute_stream, 512, 3, 1, 1, 1, new XavierInitializer<float>(), true);
  BaseLayer<float> *act5_4 = (BaseLayer<float> *)new ActivationLayer<float>(
      compute_stream, CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
