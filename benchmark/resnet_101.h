/*
 * Created Date: Wednesday, June 26th 2019, 1:44:33 pm
 * Author: Raphael-Hao
 * -----
...
#define RESNET_101_C 3
#define RESNET_101_H 227
#define RESNET_101_W 227

BaseLayer<float> *resnet_101(int stream_id, size_t batch_size) {
  ...
  BaseLayer<float> *input = (BaseLayer<float> *)new DataLayer<float>(
      compute_stream, DATA_INFER, batch_size, RESNET_101_C, RESNET_101_H,
      RESNET_101_W);
