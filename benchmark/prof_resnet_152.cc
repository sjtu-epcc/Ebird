 ...
 * Author: Raphael-Hao
 * -----
 * Last Modified: Saturday, March 21st 2020, 11:34:49 pm
...
int main(int argc, char *argv[]) {
  ...
  Network<float> *net_8_1 = new Network<float>();
  ...
  BaseLayer<float> *input_8 = resnet_152(1, 8);
  BaseLayer<float> *input_8_1 = resnet_152(2, 8);
  BaseLayer<float> *input_16 = resnet_152(2, 16);
  ...
  net_8_1->fsetup(input_8_1);
  net_16->fsetup(input_16);
  // net_32->fsetup(input_32);

  size_t pool_size = 1024;

  size_t output_size = net_16->get_output_size()/16;
  ...
  scheduler.add_worker(net_8_1, 8);
