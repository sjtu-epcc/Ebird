/*
 * Created Date: Wednesday, June 26th 2019, 4:17:20 pm
 * Author: Raphael-Hao
 * -----
 * Last Modified: Monday, March 16th 2020, 3:25:09 pm
...
int main(int argc, char *argv[]) {
  ...
  BaseLayer<float> *input_1 = vgg_16(1, 1);
  BaseLayer<float> *input_2 = vgg_16(2, 2);
  BaseLayer<float> *input_4 = vgg_16(3, 4);
  BaseLayer<float> *input_8 = vgg_16(4, 8);
  BaseLayer<float> *input_16 = vgg_16(5, 16);
  BaseLayer<float> *input_16_1 = vgg_16(6, 16);
  // BaseLayer<float> *input_32 = vgg_16(6, 32);

  size_t input_size = VGG_16_C * VGG_16_H * VGG_16_W;
