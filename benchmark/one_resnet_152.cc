 ...
 * Author: Raphael-Hao
 * -----
 * Last Modified: Saturday, March 21st 2020, 1:07:39 pm
...
int main(int argc, char *argv[]) {
  ...
  // BaseLayer<float> *input_16 = resnet_152(1, 16);
  BaseLayer<float> *input_32 = resnet_152(1, 32);
  ...
  size_t output_size = net_32->get_output_size()/32;
