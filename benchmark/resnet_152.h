/*
 * Created Date: Wednesday, June 26th 2019, 1:46:28 pm
 * Author: Raphael-Hao
 * -----
...
#define RESNET_152_C 3
#define RESNET_152_H 227
#define RESNET_152_W 227

BaseLayer<float> *resnet_152(int stream_id, size_t batch_size) {
  ...
  BaseLayer<float> *input = (BaseLayer<float> *)new DataLayer<float>(
      compute_stream, DATA_INFER, batch_size, RESNET_152_C, RESNET_152_H,
      RESNET_152_W);
